...
# It obeys a few simple rules (below) but when it's spoken quickly it's really difficult 
...
describe "#translate" do
  ...
  # Test-driving bonus:
  # * write a test asserting that capitalized words are still capitalized (but with a different 
  # initial capital letter, of course)
